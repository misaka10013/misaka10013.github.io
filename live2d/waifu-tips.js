...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["好久不见，日子过得好快呢……", "大坏蛋！你都多久没理人家了呀，嘤嘤嘤～", "嗨～快来逗我玩吧！", "拿小拳拳锤你胸口！", "记得把小家加入 Adblock 白名单哦！","御坂小主人今天到哪里去了呢，都不回来看看……"];
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			if (now > 5 && now <= 7) text = ["早上好！一日之计在于晨，美好的一天就要开始了。","有好好检查今天的工作内容吗～快去看看任务列表啦"];
			else if (now > 7 && now <= 11) text = "上午好！工作顺利嘛，不要久坐，多起来走动走动哦！";
			else if (now > 11 && now <= 13) text = "中午了，工作了一个上午，现在是午餐时间！";
			else if (now > 13 && now <= 17) text = ["午后很容易犯困呢，今天的运动目标完成了吗？","吃完午饭后一定要好好休息哦，要不然下午会很困的～"];
			else if (now > 17 && now <= 19) text = ["傍晚了！窗外夕阳的景色很美丽呢，最美不过夕阳红～","晚饭！晚饭！晚饭啦！好饿啊～"];
			else if (now > 19 && now <= 21) text = ["晚上好，今天过得怎么样？","每天要坚持看看书哦 (*•̀ㅂ•́)و ～一天一点成长～","下班了吗？～欢迎回家ヾ(*´▽‘*)ﾉ我一直等着您哟"];
			else if (now > 21 && now <= 23) text = ["已经这么晚了呀，早点休息吧，晚安～", "深夜时要爱护眼睛呀！","这么晚来找人家做什么！好困呀（揉眼睛 ( ‘-ωก̀ ) ～快去睡觉啦！"];
			else text = ["你是夜猫子呀？这么晚还不睡觉，明天起的来嘛？","你要是这么不爱惜身体的话，会让人家担心的啦！"];
